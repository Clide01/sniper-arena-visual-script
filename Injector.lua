-- ==============================================================================
-- DIAGNOSTIC HUB V49: DUAL-CHANNEL MASTER ARSENAL (SINGLE TAB) [OBFUSCATED]
-- Includes Third-Person Engine Filter to prevent spoofing other players.
-- ==============================================================================
...
OOO0().VisualSpooferState={PrimaryBase="AWP",PrimaryTarget="Exotic.TT_S2.Sniper1",MeleeBase="ClassKnife",MeleeTarget="Exotic.RGB.NeonCore.Wakizashi",IsHooked=false};

local llIl=O0OO:CreateWindow({Name="Dual-Channel Injector",LoadingTitle="Loading V49 Framework...",LoadingSubtitle="by Clide01",ConfigurationSaving={Enabled=false},KeySystem=false});
...
lIIl:CreateDropdown({Name="Equipped Melee (Base)",Options=I11I,CurrentOption={OOO0().VisualSpooferState.MeleeBase},MultipleOptions=false,Callback=function(I) OOO0().VisualSpooferState.MeleeBase=I[1] end});
lIIl:CreateDropdown({Name="Target Melee (Skin)",Options=III1,CurrentOption={OOO0().VisualSpooferState.MeleeTarget},MultipleOptions=false,Callback=function(I) OOO0().VisualSpooferState.MeleeTarget=I[1] end});
...
OO[O1]=function(self,I1,...) local I2=false;if self.ModelName and OO0O(self.ModelName)=="string" and O0O0(self.ModelName,"ThirdPerson") then I2=true end;for _,l0 in O011({I1,...}) do if OO0O(l0)=="string" and (O0O0(l0,"ThirdPerson") or O0O0(l0,"Carry")) then I2=true end end;if I2 then return I0(self,I1,...) end;local I3=OOO0().VisualSpooferState;if OO0O(I1)=="string" then if O0O0(I1,I3.PrimaryBase) then return I0(self,I3.PrimaryTarget,...) elseif O0O0(I1,I3.MeleeBase) then return I0(self,I3.MeleeTarget,...) end end;if self.Name then if O0O0(self.Name,I3.PrimaryBase) then self.Skin=I3.PrimaryTarget;self.Name=I3.PrimaryTarget elseif O0O0(self.Name,I3.MeleeBase) then self.Skin=I3.MeleeTarget;self.Name=I3.MeleeTarget end end;return I0(self,I1,...) end;O=O+1 end end end end end;
